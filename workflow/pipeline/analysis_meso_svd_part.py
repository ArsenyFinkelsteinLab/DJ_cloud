...
@schema
class ROISVDPartition(dj.Computed):
    definition = """
    -> exp2.SessionEpoch
    -> img.ROI
    ...
    def make(self, key):
        ...
        self2 = SVDSingularValuesPartition
        self3 = SVDTemporalComponentsPartition
...
@schema
class SVDSingularValuesPartition(dj.Computed):
    definition = """
    -> exp2.SessionEpoch
...
@schema
class SVDTemporalComponentsPartition(dj.Computed):
    definition = """
    -> exp2.SessionEpoch
    component_id         : int                          
    threshold_for_event  : double                       # threshold in deltaf_overf
