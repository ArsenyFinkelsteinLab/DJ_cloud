...
@schema
class ROISVDPartition1(dj.Computed):
    definition = """
    -> exp2.SessionEpoch
    -> img.ROI
    ...
    def make(self, key):
        ...
        self2 = SVDSingularValuesPartition1
        self3 = SVDTemporalComponentsPartition1
    ...
    def compute_SVD(self, self2, self3, key, rel_data1, flag_zscore, time_bin, thresholds_for_event, threshold_variance_explained, num_components_save):
        ...
        part_len = 2500 #int(np.floor(T/num_partitions))
...
@schema
class SVDSingularValuesPartition1(dj.Computed):
    definition = """
    -> exp2.SessionEpoch
...
@schema
class SVDTemporalComponentsPartition1(dj.Computed):
    definition = """
    -> exp2.SessionEpoch
    component_id         : int                          
    threshold_for_event  : double                       # threshold in deltaf_overf
