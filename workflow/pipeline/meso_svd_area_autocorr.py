...
@schema
class SVDAreaTemporalComponentsAutocorr(dj.Computed):
    definition = """
    -> exp2.SessionEpoch
    -> lab.BrainArea
    component_id         : int                          
    ...
    @property
    def key_source(self):
        return (exp2.SessionEpoch & img.Mesoscope) - exp2.SessionEpochSomatotopy
    ...
    def make(self, key):
        ...
        rel_areas = lab.BrainArea
        brain_area_strings = rel_areas.fetch('brain_area')
        ...
        for time_bin in time_bin_vector:
            for threshold in threshold_vector:
                ...
                for area in brain_area_strings:
                    ...
                    rel_comp = meso.SVDAreaTemporalComponents & "brain_area=\"%s\"" % area & key
                    ...
                    key_meso = {**key, 'time_bin': time_bin, 'threshold': threshold, 'brain_area': area}    
